...
func newApprovals(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Approvals {
	return &Approvals{
		rootSDK:          rootSDK,
...
func (s *Approvals) ListApprovals(ctx context.Context, request *operations.ListApprovalsRequest, opts ...operations.Option) (*components.ApprovalList, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
