...
func newRules(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Rules {
	return &Rules{
		rootSDK:          rootSDK,
...
func (s *Rules) List(ctx context.Context, sourceID string, opts ...operations.Option) (*operations.ListSourceRulesResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListSourceRulesResponse
...
func (s *Rules) Create(ctx context.Context, request components.CreateRuleRequest, opts ...operations.Option) (*components.SourceRule, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
// Get Rule
func (s *Rules) Get(ctx context.Context, ruleID string, opts ...operations.Option) (*components.SourceRule, error) {
...
// Update Rule
func (s *Rules) Update(ctx context.Context, ruleID string, body components.UpdateRuleRequest, opts ...operations.Option) (*components.SourceRule, error) {
...
// Delete Rule
func (s *Rules) Delete(ctx context.Context, ruleID string, opts ...operations.Option) error {
