...
func (s *Customers) List(ctx context.Context, request operations.ListCustomersRequest, opts ...operations.Option) (*operations.ListCustomersResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListCustomersResponse
...
func (s *Customers) Create(ctx context.Context, request operations.CreateCustomerRequest, opts ...operations.Option) (*operations.CreateCustomerResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			result := operations.CreateCreateCustomerResponseCreateCustomerResponseBody1(out)
			return &result, nil
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			result := operations.CreateCreateCustomerResponseCreateCustomerResponseBody2(out)
			return &result, nil
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
...
// Get
func (s *Customers) Get(ctx context.Context, id string, opts ...operations.Option) (*components.Customer, error) {
...
// Delete
func (s *Customers) Delete(ctx context.Context, id string, opts ...operations.Option) error {
...
// Update
func (s *Customers) Update(ctx context.Context, id string, body operations.UpdateCustomerRequestBody, opts ...operations.Option) (*components.Customer, error) {
...
func (s *Customers) ListCustomerPaymentMethods(ctx context.Context, id string, opts ...operations.Option) (*operations.ListCustomerPaymentMethodsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListCustomerPaymentMethodsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
