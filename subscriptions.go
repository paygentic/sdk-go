...
func (s *Subscriptions) UpdateSubscription(ctx context.Context, id string, body operations.UpdateSubscriptionRequestBody, opts ...operations.Option) (*components.Subscription, error) {
...
func (s *Subscriptions) ReconcileSubscriptionFeatures(ctx context.Context, id string, body *operations.ReconcileSubscriptionFeaturesRequestBody, opts ...operations.Option) (*components.SubscriptionReconciliation, error) {
...
func (s *Subscriptions) ListSubscriptionAdjustments(ctx context.Context, id string, limit *string, offset *string, opts ...operations.Option) (*components.SubscriptionAdjustmentsResponse, error) {
...
func (s *Subscriptions) CreateSubscriptionAdjustment(ctx context.Context, id string, body components.CreateSubscriptionAdjustmentRequest, opts ...operations.Option) (*components.SubscriptionAdjustment, error) {
