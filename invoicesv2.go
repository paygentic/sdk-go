...
func (s *InvoicesV2) DownloadInvoicePdf(ctx context.Context, id string, opts ...operations.Option) (io.ReadCloser, error) {
...
func (s *InvoicesV2) CreateInvoiceRefund(ctx context.Context, id string, body *operations.CreateInvoiceRefundRequestBody, opts ...operations.Option) (*components.InvoiceRefund, error) {
...
func (s *InvoicesV2) ListInvoiceRefunds(ctx context.Context, id string, opts ...operations.Option) (*components.InvoiceRefundList, error) {
...
func (s *InvoicesV2) VoidInvoiceRefund(ctx context.Context, id string, refundID string, body *operations.VoidInvoiceRefundRequestBody, opts ...operations.Option) (*components.InvoiceRefund, error) {
