...
func newRevenue(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Revenue {
	return &Revenue{
		rootSDK:          rootSDK,
...
func (s *Revenue) Get(ctx context.Context, request operations.GetRevenueRequest, opts ...operations.Option) (*components.RevenueSummaryResponse, error) {
