...
func newEvents(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Events {
	return &Events{
		rootSDK:          rootSDK,
...
func (s *Events) Ingest(ctx context.Context, request operations.IngestEventRequest, opts ...operations.Option) (*components.EventResponse, error) {
