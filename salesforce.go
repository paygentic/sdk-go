...
func newSalesforce(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Salesforce {
	return &Salesforce{
		rootSDK:          rootSDK,
...
func (s *Salesforce) ListSalesforceAccounts(ctx context.Context, merchantID string, q *string, limit *int64, offset *int64, opts ...operations.Option) (*operations.ListSalesforceAccountsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListSalesforceAccountsResponse
