...
func (s *Payments) List(ctx context.Context, request *operations.ListPaymentsRequest, opts ...operations.Option) (*operations.ListPaymentsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListPaymentsResponse
...
func (s *Payments) Create(ctx context.Context, request operations.CreatePaymentRequest, opts ...operations.Option) (*components.Payment, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Payments) Get(ctx context.Context, id string, opts ...operations.Option) (*components.Payment, error) {
