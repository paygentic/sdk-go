...
func newDisputes(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Disputes {
	return &Disputes{
		rootSDK:          rootSDK,
...
func (s *Disputes) Create(ctx context.Context, request components.CreateDisputeRequest, opts ...operations.Option) (*components.Dispute, error) {
...
func (s *Disputes) List(ctx context.Context, request *operations.ListDisputesRequest, opts ...operations.Option) (*operations.ListDisputesResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListDisputesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
