...
func newUsers(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Users {
	return &Users{
		rootSDK:          rootSDK,
...
// Get
func (s *Users) Get(ctx context.Context, id string, opts ...operations.Option) (*components.User, error) {
...
// Update
func (s *Users) Update(ctx context.Context, id string, body operations.UpdateUserRequestBody, opts ...operations.Option) (*components.User, error) {
