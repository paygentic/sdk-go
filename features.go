...
func newFeatures(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Features {
	return &Features{
		rootSDK:          rootSDK,
...
func (s *Features) List(ctx context.Context, productID string, key *string, limit *int64, offset *int64, opts ...operations.Option) (*operations.ListFeaturesResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListFeaturesResponse
...
// Create
func (s *Features) Create(ctx context.Context, request operations.CreateFeatureRequest, opts ...operations.Option) (*components.Feature, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
// Get
func (s *Features) Get(ctx context.Context, id string, opts ...operations.Option) (*components.Feature, error) {
...
// Update
func (s *Features) Update(ctx context.Context, id string, body operations.UpdateFeatureRequestBody, opts ...operations.Option) (*components.Feature, error) {
...
// Delete
func (s *Features) Delete(ctx context.Context, id string, opts ...operations.Option) error {
