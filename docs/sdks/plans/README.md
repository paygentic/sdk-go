...
<!-- UsageSnippet language="go" operationID="createPlan" method="post" path="/v0/plans" -->
```go
package main
...
func main() {
    ...
    res, err := s.Plans.Create(ctx, operations.CreatePlanRequest{
        Currency: "Won",
        MerchantID: "<id>",
        Name: "<value>",
        ProductID: "<id>",
...
<!-- UsageSnippet language="go" operationID="listPlans" method="get" path="/v0/plans" -->
```go
package main
...
func main() {
    ...
    res, err := s.Plans.List(ctx, paygentic.Pointer[int64](10), nil, paygentic.Pointer[int64](0), nil)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
<!-- UsageSnippet language="go" operationID="listAvailablePlans" method="get" path="/v0/plans/available" -->
```go
package main
...
func main() {
    ...
    res, err := s.Plans.ListAvailable(ctx, operations.ListAvailablePlansRequest{
        CustomerID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
...
**[*operations.ListAvailablePlansResponse](../../models/operations/listavailableplansresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="getPlan" method="get" path="/v0/plans/{id}" -->
```go
package main
...
| -------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------- |
| `ctx`                                                    | [context.Context](https://pkg.go.dev/context#Context)    | :heavy_check_mark:                                       | The context to use for the request.                      |
| `id`                                                     | `string`                                                 | :heavy_check_mark:                                       | The unique identifier of the plan                        |
| `opts`                                                   | [][operations.Option](../../models/operations/option.md) | :heavy_minus_sign:                                       | The options for this request.                            |
...
<!-- UsageSnippet language="go" operationID="updatePlan" method="patch" path="/v0/plans/{id}" -->
```go
package main
...
func main() {
    ...
    res, err := s.Plans.Update(ctx, "<id>", operations.UpdatePlanRequestBody{})
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
| `ctx`                                                                                | [context.Context](https://pkg.go.dev/context#Context)                                | :heavy_check_mark:                                                                   | The context to use for the request.                                                  |
| `id`                                                                                 | `string`                                                                             | :heavy_check_mark:                                                                   | The unique identifier of the plan                                                    |
| `body`                                                                               | [operations.UpdatePlanRequestBody](../../models/operations/updateplanrequestbody.md) | :heavy_check_mark:                                                                   | N/A                                                                                  |
| `opts`                                                                               | [][operations.Option](../../models/operations/option.md)                             | :heavy_minus_sign:                                                                   | The options for this request.                                                        |
