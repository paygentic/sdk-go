...
<!-- UsageSnippet language="go" operationID="createDispute" method="post" path="/v0/disputes" -->
```go
package main
...
func main() {
    ...
    res, err := s.Disputes.Create(ctx, components.CreateDisputeRequest{
        Message: "<value>",
        UsageEventID: "<id>",
    })
    if err != nil {
...
| `request`                                                                          | [components.CreateDisputeRequest](../../models/components/createdisputerequest.md) | :heavy_check_mark:                                                                 | The request object to use for the request.                                         |
| `opts`                                                                             | [][operations.Option](../../models/operations/option.md)                           | :heavy_minus_sign:                                                                 | The options for this request.                                                      |

### Response

**[*components.Dispute](../../models/components/dispute.md), error**
...
<!-- UsageSnippet language="go" operationID="listDisputes" method="get" path="/v0/disputes" -->
```go
package main
