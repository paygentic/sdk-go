...
value := components.DocumentWithheldReasonTaxUnreconciled

// Open enum: custom values can be created with a direct type cast
custom := components.DocumentWithheldReason("custom_value")
```
...
| Name                                             | Value                                            |
| ------------------------------------------------ | ------------------------------------------------ |
| `DocumentWithheldReasonTaxUnreconciled`          | tax_unreconciled                                 |
| `DocumentWithheldReasonIssuerIdentityIncomplete` | issuer_identity_incomplete                       |
| `DocumentWithheldReasonTaxComponentUnpriceable`  | tax_component_unpriceable                        |
| `DocumentWithheldReasonLedgerMismatch`           | ledger_mismatch                                  |
| `DocumentWithheldReasonTaxProviderDisagrees`     | tax_provider_disagrees                           |