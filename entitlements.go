...
func newEntitlements(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Entitlements {
	return &Entitlements{
		rootSDK:          rootSDK,
...
func (s *Entitlements) List(ctx context.Context, request operations.ListEntitlementsRequest, opts ...operations.Option) (*operations.ListEntitlementsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListEntitlementsResponse
...
func (s *Entitlements) Get(ctx context.Context, entitlementID string, at *time.Time, opts ...operations.Option) (*components.EntitlementDetail, error) {
