...
func newPrices(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Prices {
	return &Prices{
		rootSDK:          rootSDK,
...
func (s *Prices) List(ctx context.Context, billableMetricID *string, limit *int64, offset *int64, opts ...operations.Option) (*operations.ListPricesResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListPricesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// Delete
func (s *Prices) Delete(ctx context.Context, id string, opts ...operations.Option) error {
