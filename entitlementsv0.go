...
func newEntitlementsV0(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *EntitlementsV0 {
...
func (s *EntitlementsV0) ListActive(ctx context.Context, customerID string, productID *string, subscriptionID *string, opts ...operations.Option) (*operations.GetActiveEntitlementsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetActiveEntitlementsResponse
...
func (s *EntitlementsV0) Create(ctx context.Context, request components.CreateEntitlementRequest, opts ...operations.Option) (*components.Entitlement, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
